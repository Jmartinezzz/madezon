        ...
        <UsersLayout>
            ...
            <div className="mt-5">
                <div className="surface-0 text-700 text-center">
                    ...
                    <div className="text-700 text-xl mb-5">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Velit numquam eligendi quos.</div>
                    {/* <InputText value={value} onChange={(e) => setValue(e.target.value)} /> */}
                    {/* <InputText placeholder='Ingresa una url de Amazon válida' className='text-lg font-italic border-primary border-round-lg w-12 shadow-1 border-2 custom-padding' /> */}
                </div>
                    ...
                    <div className="w-12 md:w-6 text-lg">
                        <form onSubmit={handleSubmit} className="mt-3">
                            ...
                            <section className='flex justify-content-end mt-3'>
                                <Button label='Cotizar' raised processing={processing} />
                            </section>
                        </form>
                    </div>
                </div>
